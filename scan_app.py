...
RULES = [
    ...
    (BLOCK, "dynamic-script",
     re.compile(r"createElement\(\s*[\"'`]script[\"'`]"),
     "Dynamically creates a <script> element — a path to load and run code that wasn't present at review. Inline it."),
...
def scan(path):
    ...
    bridges = sorted(set(re.findall(r"\bmyllm(?:Fetch|Storage|Ask|Vision|Generate\w+|Location|Steps|Widget|Chat|"
